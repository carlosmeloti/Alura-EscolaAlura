package br.com.carlosmelocursos.escolaAlura.codecs;
...
import br.com.carlosmelocursos.escolaAlura.models.Curso;
...
public class AlunoCodec implements CollectibleCodec<Aluno> {
	...
	public BsonValue getDocumentId(Aluno aluno) {
		if(!documentHasId(aluno)) {
			throw new IllegalStateException("Este aluno não tem ID");
		}
		return null;
	}
